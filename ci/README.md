...
Pipeline running at ${CONCOURSE_URL}/kafka-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml kafka-boshrelease --paused=false
```
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml kafka-boshrelease-image --paused=false
```
